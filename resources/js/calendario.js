console.log('📅 Calendario básico cargado');
...
const calendar = {
  ...
  selectDate(date) {
    ...
    // Notificar a la página si existe la función onFechaSeleccionada
    const fechaStr = `${this.selectedDate.getFullYear()}-${String(this.selectedDate.getMonth() + 1).padStart(2, '0')}-${String(this.selectedDate.getDate()).padStart(2, '0')}`;
    if (typeof onFechaSeleccionada === 'function') {

...
@section('eventoNombre')
   Reservar en {{ $evento->nombre }}
@endsection
...
@section('contenido')
   <section class="bg-base-100 min-h-[100vh] lg:pt-20 pb-30">
      ...
      <div class="relative border border-base-content/10 shadow bg-base-100 mx-auto max-w-3xl lg:rounded-3xl overflow-hidden">
         ...
         <div class="caja py-10 px-5 border-t border-base-content/10 shadow space-y-7">
            <p class="text-base-content text-base-content/50 text-sm text-justify">
               Rezerva.es es una <strong>plataforma online</strong> para eventos en donde pueden crear su <strong>propio portal de reservas online</strong> y compartirla con todo el mundo de manera rápida y directa. Sube tu audiencia en las <strong>búsquedas de Google</strong>.
            </p>

            <p class="text-base-content text-base-content/50 text-sm text-justify">
               Al realizar una reserva en <strong>{{ $evento->nombre }}</strong>, el usuario contrata directamente con el evento o profesional responsable del servicio. Rezerva.es actúa exclusivamente como intermediario tecnológico, facilitando la gestión de reservas y pagos online.
            </p>
            ...
            <div class="caja">
               ...
               <p class="text-base-content/90 text-sm">
                  ¿Quieres que tu evento esté online? <a class="hover:underline text-blue-600" href="https://rezerva.es/registro">Regístrate en Rezerva.es</a>
               </p>
            </div>
         </div>
      </div>
               ...
               <div class="sm:flex sm:items-start">
                  <div class="mt-3 text-center sm:mt-0 sm:text-left">
                     ...
                     <div class="mt-5 space-y-5">
                        ...
                        <form id="clienteForm" action="{{ route('api.check.evento') }}" class="text-start" method="post">
                           @csrf

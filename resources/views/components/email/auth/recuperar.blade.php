                        ...
                        <tr style="width:100%">
                           <td>
                              ...
                              <p
                                 ...
                                 Has solicitado el cambio de contraseña para tu cuenta de
                                 <strong>{{ env('APP_NAME') }}</strong>. Para poder proceder con el
                                 procedimiento de cambio de contraseña, puede cambiarla en
                                 el siguiente botón.
                              </p>
                              <table
                                 align="center"
                                       ...
                                       <td>
                                          <a
                                             ...
                                             target="_blank"><span></span><span
                                                style="max-width:100%;display:inline-block;line-height:120%;mso-padding-alt:0px;mso-text-raise:7.5px">Restablecer contraseña</span><span></span></a>
                                       </td>
                                    </tr>
                                 </tbody>
                              </table>

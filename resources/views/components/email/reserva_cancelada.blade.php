                     ...
                     <tbody>
                        <tr style="width:100%">
                           <td>
                              ...
                              <h1
                                 style="font-size:1.5rem;line-height:1.3333333333333333;color:rgb(231, 40, 40);font-weight:400;text-align:left;padding:0rem;margin-bottom:2rem;margin-top:2rem;margin-right:0rem;margin-left:0rem">
                                 Reserva cancelada
                              </h1>
                              <p
                              ...
                              <p
                                 ...
                                 Tu reserva ha sido cancelada exitosamente. No tienes que hacer más nada, ya hemos comunicado al sitio que tu reserva se ha cancelado.
                              </p>
                              <p
                                 style="font-size:0.875rem;line-height:1.625;text-align:start;color:rgb(0,0,0);margin-top:16px;margin-bottom:16px"></p>
                              <p
                                 style="font-size:0.875rem;line-height:1.4285714285714286;text-align:start;color:rgb(0,0,0);margin-top:16px;margin-bottom:16px">
                                 El equipo de <strong>{{ env('APP_NAME') }}</strong>
                              </p>
                           </td>
                        </tr>
                     </tbody>

                        ...
                        <tr style="width:100%">
                           <td>
                              ...
                              <p
                                 ...
                                 Hemos cambiado tu reserva al día que solicitaste,
                              </p>
                              <p
                              ...
                              <p style="font-size:0.875rem;line-height:1.625;text-align:start;color:rgb(0,0,0);margin-top:16px;margin-bottom:16px">

                                 <strong>{{ Carbon\Carbon::parse($datos['reserva']['fecha'])->translatedFormat('l d M') }}</strong> a las
                                 <strong>{{ Carbon\Carbon::parse($datos['reserva']['fecha'])->translatedFormat('H:i \h') }}</strong>. Te sugerimos que puedas guardar bien la fecha para evitar confusiones o cancelaciones por inasistencia.
                              </p>
                              <p
                                 style="font-size:0.875rem;line-height:1.625;text-align:start;color:rgb(0,0,0);margin-top:16px;margin-bottom:16px"></p>
                              <p
                                 style="font-size:0.875rem;line-height:1.4285714285714286;text-align:start;color:rgb(0,0,0);margin-top:16px;margin-bottom:16px">
                                 Puedes editar tu reserva / cita en tu panel de control.<br />el

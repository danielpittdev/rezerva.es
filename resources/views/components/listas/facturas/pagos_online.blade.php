@if ($pagosOnline->count() > 0)
   @foreach ($pagosOnline as $reserva)
      <li class="flex items-center justify-between gap-x-6 p-3 px-5 hover:bg-base-200/50">
         <div class="flex items-center gap-3 min-w-0 pl-4 border-l-4 border-green-500">
         ...
         <div class="flex items-center gap-3">
            ...
            <span class="rounded-full bg-green-500/20 px-2 py-0.5 text-xs font-medium text-green-600">
               Pagado
            </span>
         </div>
      </li>
   ...
   <li class="flex items-center justify-between gap-x-6 p-3">
      <div class="min-w-0">
         <div class="mt-1 flex items-center gap-x-2">
            <p class="truncate text-base-content/70">No hay pagos online registrados</p>
         </div>
      </div>
   </li>
@endif

      ...
      <div class="flex flex-1 flex-col justify-center px-4 py-12 sm:px-6 lg:flex-none lg:px-20 xl:px-24">
         <div class="mx-auto w-full max-w-sm lg:w-96">
            <div>
               ...
               <h2 class="mt-8 text-2xl/9 font-bold tracking-tight">Recuperación de contraseña</h2>
               <p class="mt-2 text-sm/6 text-gray-400">
                  ¿Te acordaste?
                  <a href="{{ route('registro') }}" class="font-semibold text-indigo-500 hover:text-indigo-300">Inicia sesión</a>
               </p>
            </div>

            <div class="mt-10">
               <div>
                  <form id="recuperacion" action="{{ route('api_recuperar') }}" method="POST" class="space-y-6">
                     @csrf
                     <div>

        ...
        <div class="sm:mx-auto sm:w-full sm:max-w-md">
            <div class="bg-base-100 py-8 px-4 shadow-xl rounded-lg sm:px-10">
                <div class="text-center">
                    ...
                    <h2 class="text-2xl font-bold text-base-content mb-2">Pago cancelado</h2>
                    <p class="text-base-content/70 mb-6">
                        El pago para <strong>{{ $reserva->servicio->nombre }}</strong> ha sido cancelado.
                    </p>
                    ...
                    <p class="text-sm text-base-content/60">
                        Puedes solicitar un nuevo enlace de pago al negocio.
                    </p>
                </div>
            </div>
        </div>

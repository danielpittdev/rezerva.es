...
@section('contenido')
   <section class="bg-base-100 min-h-[100vh] lg:pt-10 pb-30">
      <div class="relative lg:border border-base-content/10 shadow bg-base-100 mx-auto xl:max-w-2xl max-w-md max-w-md lg:rounded-3xl overflow-hidden">
                     ...
                     <div class="calendai bg-base-100">
                        ...
                        <div class="border border-base-content/10 rounded-xl xl:block hidden caja overflow-hidden">
                           ...
                           <div class="flex items-center justify-center text-base-content p-1">
                              <div class="flex w-full items-center justify-between bg-base-100 rounded-lg border border-base-content/10">
                                 <button type="button" type="button" id="btn-prev-month" class="p-2 hover:bg-base-200 duration-300 border-r border-base-content/10 flex flex-none items-center justify-center p-1.5 text-base-content hover:text-gray-500">
                                 ...
                                 <button type="button" type="button" id="btn-next-month" class="p-2 block hover:bg-base-200 duration-300 border-l border-base-content/10 flex flex-none items-center justify-center p-1.5 text-base-content hover:text-gray-500">
                        ...
                        <div class="space-y-4 xl:hidden block">
                           ...
                           <div class="flex items-center justify-between">
                              <button type="button" id="btn-prev" class="p-2 rounded-full hover:bg-base-300">
                              ...
                              <button type="button" id="btn-next" class="p-2 rounded-full hover:bg-base-300">
                                 <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-base-content " fill="none" viewBox="0 0 24 24" stroke="currentColor">

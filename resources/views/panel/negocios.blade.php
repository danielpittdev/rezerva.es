   ...
   <section class="py-4 flex justify-between items-start">
      <div class="caja space-y-2">
         ...
         <p class="text-xs text-base-content/70">
            Gestiona tus negocios cómodamente
         </p>
      </div>
...
@section('drawers')
   <el-dialog id="modal_o">
      <dialog id="drawer_crear_negocio" aria-labelledby="drawer-title" class="fixed inset-0 size-auto max-h-none max-w-none overflow-hidden bg-transparent not-open:hidden backdrop:bg-transparent">
               ...
               <div class="relative flex h-full flex-col overflow-y-auto bg-base-100 border-l border-base-content/20 py-6 shadow-xl">
                  <div class="px-4 sm:px-6">
                     <div class="flex items-start justify-between">
                        <h2 id="drawer-title" class="text-base font-semibold text-base-content">Panel title</h2>
                        <div class="ml-3 flex h-7 items-center">
                           <button type="button" command="close" commandfor="drawer_crear_negocio" class="relative rounded-md text-gray-400 hover:text-gray-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                  ...
                  <div class="relative mt-6 flex-1 px-4 sm:px-6">
                     ...
                     <form id="crearNegocio" action="{{ route('negocio.store') }}" method="POST" class="grid lg:grid-cols-4 grid-cols-1 gap-3">
                        @csrf
                        ...
                        <div class="lg:col-span-2 col-span-full">
                           ...
                           @php
                              $tipos = ['barberia', 'psicologia', 'restaurante', 'otros'];
                           @endphp
                        ...
                        <div class="lg:col-span-full col-span-full">
                           ...
                           <div class="mt-2">
                              <input id="postal_direccion" type="text" name="postal_direccion" autocomplete="postal_direccion"
                                 class="block w-full rounded-md px-3 py-1.5 bg-base-200 text-base outline-1 -outline-offset-1 outline-base-content/20 placeholder:text-base-content/70 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-500 sm:text-sm/6" />
                           </div>
                        </div>
                        ...
                        <div class="lg:col-span-2 col-span-full">
                           ...
                           <div class="mt-2">
                              <input id="postal_pais" type="text" name="postal_pais" autocomplete="postal_pais"
                                 class="block w-full rounded-md px-3 py-1.5 bg-base-200 text-base outline-1 -outline-offset-1 outline-base-content/20 placeholder:text-base-content/70 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-500 sm:text-sm/6" />
                           </div>
                        </div>
                        ...
                        <div class="lg:col-span-2 col-span-full">
                           ...
                           <div class="mt-2">
                              <input id="postal_ciudad" type="text" name="postal_ciudad" autocomplete="postal_ciudad"
                                 class="block w-full rounded-md px-3 py-1.5 bg-base-200 text-base outline-1 -outline-offset-1 outline-base-content/20 placeholder:text-base-content/70 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-500 sm:text-sm/6" />
                           </div>
                        </div>
                        ...
                        <div class="lg:col-span-full col-span-full">
                           ...
                           <div class="mt-2">
                              <input id="postal_codigo" type="text" name="postal_codigo" autocomplete="postal_codigo"
                                 class="block w-full rounded-md px-3 py-1.5 bg-base-200 text-base outline-1 -outline-offset-1 outline-base-content/20 placeholder:text-base-content/70 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-500 sm:text-sm/6" />
                           </div>
                        </div>
                        ...
                        <!-- Email contacto -->
                        <div class="lg:col-span-full col-span-full">
                           <label for="contacto_email" class="block text-sm/6 font-medium">Correo electrónico</label>
                           <div class="mt-2">
                              <input id="contacto_email" type="text" name="contacto_email" autocomplete="contacto_email"
                                 class="block w-full rounded-md px-3 py-1.5 bg-base-200 text-base outline-1 -outline-offset-1 outline-base-content/20 placeholder:text-base-content/70 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-500 sm:text-sm/6" />
                           </div>
                        </div>
                        ...
                        <!-- Teléfono contacto -->
                        <div class="lg:col-span-full col-span-full">
                           <label for="contacto_telefono" class="block text-sm/6 font-medium">Teléfono</label>
                           <div class="mt-2">
                              <input id="contacto_telefono" type="text" name="contacto_telefono" autocomplete="contacto_telefono"
                                 class="block w-full rounded-md px-3 py-1.5 bg-base-200 text-base outline-1 -outline-offset-1 outline-base-content/20 placeholder:text-base-content/70 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-500 sm:text-sm/6" />
                           </div>
                        </div>
                     ...
                     <script>
                        const crearNegocioForm = document.getElementById('crearNegocio');

                        crearNegocioForm.addEventListener('submit', (e) => {
                           e.preventDefault();
                           peticion(crearNegocioForm, {
                              resetForm: true,
...
@section('scripts')
   <script>
      function llamadaLista() {
         $.ajax({
            type: "GET",
            url: "{{ route('negocio.index') }}",
            headers: {
               "Authorization": "Bearer " + localStorage.getItem('token'),
               "Accept": "application/json"
            },
            beforeSend: function() {
               $('#load_lista_negocios').empty().append(`
                  <li class="flex py-8">
                     <span class="mx-auto loading loading-spinner loading-md"></span>
                  </li>
               `)
            ...
            success: function(r) {
               ...
               $('#load_lista_negocios').empty().append(r.lista)
            },
            error: function(e) {

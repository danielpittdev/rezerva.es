   ...
   <section class="py-4 flex justify-between items-start">
      <div class="caja space-y-2">
         ...
         <p class="text-xs text-base-content/70">
            Gestiona tus horarios para recibir reservas.
         </p>
      </div>
                  ...
                  <div class="relative mt-6 flex-1 px-4 sm:px-6">
                     ...
                     <form id="crearHorario" action="{{ route('horario.store') }}" method="POST" class="grid lg:grid-cols-4 grid-cols-1 gap-3 gap-y-7">
                           ...
                           <fieldset aria-label="Elige un día">
                              ...
                              <div class="mt-2 grid grid-cols-3 gap-3 sm:grid-cols-4">
                                 <label aria-label="Lunes"
                                    ...
                                    <input type="checkbox" name="dia[]" value="monday" checked class="absolute inset-0 appearance-none focus:outline-none disabled:cursor-not-allowed" />
                        ...
                        <div class="lg:col-span-2 col-span-full">
                           <label for="tipo_horario" class="block text-sm/6 font-medium">Tipo de horario</label>

                           <div class="mt-2">
                              @php
                                 $tipos = ['recurrente', 'puntual'];
                              @endphp
                              <el-select id="tipo_horario" name="tipo_horario" value="{{ $tipos[0] }}" class="mt-2 block">
                                 <button type="button"
...
@section('scripts')
   <script>
      function llamadaLista() {
         ...
         let id = "{{ Auth::user()->negocios[0]->uuid }}";
